...
void 	*f2h_axi_master  	= NULL;
size_t f2h_axi_master_span = ALT_FPGA_BRIDGE_LWH2F_UB_ADDR- ALT_FPGA_BRIDGE_LWH2F_LB_ADDR + 1;
size_t f2h_axi_master_ofst = ALT_FPGA_BRIDGE_LWH2F_OFST;
